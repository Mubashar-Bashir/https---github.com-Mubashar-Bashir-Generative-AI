...
from app.models.notification_model import Notification, Notification  # Import notification model if needed
import asyncio
    ...
    async for consumer in get_kafka_consumer(topic):
        async for msg in consumer:
            try:
                ...
                update_data = Notification(**message_data.get('update_data'))  # Extract update_data from message
