...
KAFKA_CREATE_PAYMENT_TOPIC = config("KAFKA_CREATE_PAYMENT_TOPIC", cast=str)
KAFKA_UPDATE_PAYMENT_TOPIC = config("KAFKA_UPDATE_PAYMENT_TOPIC", cast=str)
KAFKA_DELETE_PAYMENT_TOPIC = config("KAFKA_DELETE_PAYMENT_TOPIC", cast=str)

#strip api key
stripe_API_Key = config("STRIPE_SECRET_KEY", cast = Secret)